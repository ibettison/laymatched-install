...
def _emit_dns_wait_progress(started_at: float, next_progress_at: float, reservation: dict) -> float:
...
def reserve_hostname(args) -> int:
    ...
    while True:
        ...
        next_progress_at = _emit_dns_wait_progress(started_at, next_progress_at, reservation)
